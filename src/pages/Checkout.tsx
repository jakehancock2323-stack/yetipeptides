...
export default function Checkout() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Order data always sent in USD for backend processing
    const orderData = {
    ...
    <div className="min-h-screen pb-20">
      ...
      <div className="container mx-auto px-4 pt-28">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          <div className="frosted-glass rounded-lg p-4 sm:p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="pt-4">
                ...
                <div className="mb-4 p-4 rounded-lg border border-ice-blue/30 bg-card/50">
                  <div className="flex items-center justify-center gap-6 mb-3">
                    <div className="flex items-center gap-2">
                      <Lock className="w-4 h-4 text-ice-blue" />
                      <span className="text-xs text-muted-foreground">Secure Checkout</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CreditCard className="w-4 h-4 text-ice-blue" />
          ...
          {/* Order Summary */}
          <div>
            <div className="frosted-glass rounded-lg p-4 sm:p-6 md:sticky md:top-28">
